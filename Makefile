...
SRC_2_FILES += $(APP_2_SRC_FILES)
SRC_2_FILES += $(IOT_SRC_FILES)
...
MAKE_CMD_APP_1 = $(CC) $(SRC_FILES) $(COMPILER_FLAGS) -o $(APP_NAME) $(LD_FLAG) $(EXTERNAL_LIBS) $(INCLUDE_ALL_DIRS)
MAKE_CMD_APP_2 = $(CC) $(SRC_2_FILES) $(COMPILER_FLAGS) -o $(APP_2_NAME) $(LD_FLAG) $(EXTERNAL_LIBS) $(INCLUDE_ALL_DIRS)

all:
	$(PRE_MAKE_CMD)
	$(DEBUG)$(MAKE_CMD_APP_1)
	$(DEBUG)$(MAKE_CMD_APP_2)
	$(POST_MAKE_CMD)

clean:
	rm -f $(APP_DIR)/$(APP_NAME)
	rm -f $(APP_DIR)/$(APP_2_NAME)
