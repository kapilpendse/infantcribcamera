...
#define POLLY_PROMPT_LOOK_AT_CAMERA	"<speak>Hello! This door opens after facial verification. Please look at the camera. Remember to remove your glasses if you are wearing any.<break time='1s'/> Five. Four. Three. Two. One. And click!</speak>"
